...
// Offsets
#define ADDRESS_PLAYERSTATE_S 0x1EA98E60                  // [[48 63 C1 48 69 C8 60 03 00 00 48 8D ? ? ? ? ? 48 03 C8 E9] + 0xA] lea - 0x18
#define ADDRESS_NUM_OF_PLAYERS 0x1E60772C                 // [74 1D 48 8B 8B ? ? ? ? 48 2B 8E ? ? ? ? 2B 05 ? ? ? ?] - 0x17                     2B 05 6E3F9A13        - sub eax,[ADDRESS_GAMEMODE]
#define ADDRESS_CHECK_UPDATE 0x43B9E5C                    // [74 1D 48 8B 8B ? ? ? ? 48 2B 8E ? ? ? ? 2B 05 ? ? ? ?]
...
#define ADDRESS_WEAPON_COMPLETE_DEF 0x1B487E20            // 
